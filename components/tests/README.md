...
- `test-settings-card.tsx`: Test mode, independently selectable answer scope (species/genus/family), answer name mode
  (scientific/vernacular/either), and question-count controls.
