...
Learning analytics and progress visualization components.

- `segmented-learning-progress.tsx`: Multi-row, species-aware segmented learning progress bar with expanded hover
  reaction areas, measured zoomed-segment overlays, optional overlay visibility gating, and click-to-segment navigation
  hooks.
