...
- `[stackId]/page.tsx`: End-to-end test experience including settings, adaptive species sampling by familiarity, answer
  ...
  tracking, stack outcome histogram updates, multiple-choice 50/50 elimination support, Misty Marshland full-viewport
  atmospheric background rendering, and exit actions that return to the parent collection when available.
