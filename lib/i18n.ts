...
const FI_MESSAGES: TranslationTable = {
  ...
  "learn.cards.noSpeciesWithImages": "Tässä pinkassa ei ole lajeja, joilla on kuvia.",
  ...
  "learn.cards.shortcut.showIdentificationTab":
    "Näytä tunnistus-välilehti",
